...
The helloWeather app was built with HTML, CSS and JavaScript! Check my previous repos for the [hiWeather](https://tgd-weather.netlify.app) App.
...
- Generate a new API key (it may take a few minutes to activate)
...
Copyright (c) 2025 Oluwakemi Obadeyi start using the weather app.
